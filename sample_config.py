...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@e1ggg")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/mnxs8/telethonAr1")
    AUTONAME = os.environ.get("AUTONAME", "@e1ggg")
    ...
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://g.top4top.io/p_2369ntd8f1.jpeg")
